...
tape("filter-parser field selectors", function(test) {
	...
	test.deepEqual(fieldParser.parse("x|filter1: true, 1, 2, false|filter2|filter3: null"), { value: { fieldSelectors: [ "x" ], filterReferences: [ { name: "filter1", args: [ null, true, 1, 2, false, null, null ] }, { name: "filter2", args: [ null, null, null ] }, { name: "filter3", args: [ null, null, null, null ] } ] }, index: 50 }, "Parse <x|filter1: true, 1, 2, false|filter2|filter3: null>");
	test.deepEqual(fieldParser.parse('x|filter1: true, [ { "a": "b" }, 2 ], false|filter2|filter3: null}'), { value: { fieldSelectors: [ "x" ], filterReferences: [ { name: "filter1", args: [ null, true, [ { "a": "b" }, 2 ], false, null, null ] }, { name: "filter2", args: [ null, null, null ] }, { name: "filter3", args: [ null, null, null, null ] } ] }, index: 65 }, "Parse <x|filter1: true, [ { \"a\": \"b\" }, 2 ], false|filter2|filter3: null}> (partial)");
	test.deepEqual(fieldParser.parse('  ß  |   filter1: true , [ { "a"  : "b" } , 2 ] , false  |  filter2  | filter3:  null   }'), { value: { fieldSelectors: [ "ß" ], filterReferences: [ { name: "filter1", args: [ null, true, [ { "a": "b" }, 2 ], false, null, null ] }, { name: "filter2", args: [ null, null, null ] }, { name: "filter3", args: [ null, null, null, null ] } ] }, index: 88 }, "Parse <  ß  |   filter1: true , [ { \"a\"  : \"b\" } , 2 ] , false  |  filter2  | filter3:  null   }> (partial)");
	test.deepEqual(fieldParser.parse("~a"), { value: undefined, index: 0, errorCode: "MISSING_VALID_FIELD_SELECTOR" }, "Parse <~a>");
	test.deepEqual(fieldParser.parse("x | filter1 | filter2 filter3"), { value: { fieldSelectors: [ "x" ], filterReferences: [ { name: "filter1", args: [ null, null, null ] }, { name: "filter2", args: [ null, null, null ] } ] }, index: 22 }, "Parse <x | filter1 | filter2 filter3> (partial)");
